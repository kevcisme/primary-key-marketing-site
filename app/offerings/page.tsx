...
const featureItems = [
  {
    ...
    description:
      "Pixel-perfect designs that delight users and elevate brands.",
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-dots bg-punch-card/30 dark:bg-neutral-900" />
    ),
    icon: <IconPalette className="h-4 w-4 text-amber-glow" />,
    className: "md:col-span-1",
  },
  {
    title: "Cross-Platform",
    description:
      "One codebase, every device. Web, mobile, and desktop — seamlessly.",
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-dots bg-punch-card/30 dark:bg-neutral-900" />
    ),
    icon: <IconDevices className="h-4 w-4 text-amber-glow" />,
    className: "md:col-span-1",
  },
  {
    title: "Secure by Default",
    description:
      "Security baked in from day one — not bolted on as an afterthought.",
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-dots bg-punch-card/30 dark:bg-neutral-900" />
    ),
    icon: <IconShieldCheck className="h-4 w-4 text-amber-glow" />,
    className: "md:col-span-1",
  },
  {
    title: "Data-Driven",
    description:
      "Analytics and insights that drive product decisions and growth.",
    header: (
      <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-dots bg-punch-card/30 dark:bg-neutral-900" />
    ),
    icon: <IconChartBar className="h-4 w-4 text-amber-glow" />,
...
export default function Offerings() {
  return (
    <div className="font-[family-name:var(--font-geist-sans)]">
      {/* Hero with Spotlight */}
      <section className="relative flex flex-col items-center justify-center min-h-[60vh] bg-neutral-950 overflow-hidden">
        <Spotlight
      ...
      <section className="px-8 py-20 sm:px-20">
        ...
        <h2 className="text-3xl md:text-5xl font-bold mb-12 max-w-7xl mx-auto">
      ...
      <section className="flex flex-col items-center justify-center py-16 px-8">
        <p className="font-mono-accent text-neutral-400 text-sm">
          &gt; {allProjects.length} projects built and counting
        </p>
      </section>
    </div>
  );
